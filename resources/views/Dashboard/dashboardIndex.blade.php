        ...
        <div id="page_top" class="section-body">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title">Tableau de board</h1>
                    </div>
                    <div class="right">
                        <div class="notification d-flex">
                            <button type="button" class="btn btn-facebook"><i class="fa fa-power-off mr-2"></i>Se déconnecter</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <div class="card">
                            <div class="card-body ribbon">
                                ...
                                <a href="app-email.html" class="my_sort_cut text-muted">
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <div class="card">
                            <div class="card-body">
                                <a href="app-social.html" class="my_sort_cut text-muted">
...
<script src="{{ asset('admin/bundles/flot.bundle.js') }}"></script>
<script src="{{ asset('admin/bundles/jvectormap1.bundle.js') }}"></script>
