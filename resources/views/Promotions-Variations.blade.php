            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Liste des promotions sur des variations</h1>
                        </div>
                        @auth
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6 d-flex justify-content-between align-items-center">
                                            <form action="{{ route('promotions_variations') }}" method="GET"
                                                ...
                                                <div id="addrowExample_filter" class="dataTables_filter mr-2">
                                                    <label><strong>Nom variation:<input type="search"
                                                                class="form-control" aria-controls="addrowExample"
                                                                name="chercherVariation"
                                                                value="{{ $chercherVariation }}"></strong></label>
                                                </div>
                                                <button type="submit" class="btn btn-icon btn-primary" style="margin-top:10px;"><i
                                        ...
                                        <table class="table table-hover table-vcenter table-striped" cellspacing="0"
                                            ...
                                            <tbody>
                                                @foreach ($promotions as $promo)
                                                    @foreach ($promo->variations as $variation)
                                                        <tr class="gradeA">
                                                            <td>
                                                                {{ $variation->pivot->id }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge badge-info custom-badge">{{ $variation->name }}</span>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="badge badge-warning custom-badge">{{ $promo->pourcentage_promo }}
                                                                    %</span>
                                                            </td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="addrowExample_info" role="status"
                                                ...
                                                sur {{ $totalPromotions }} promotions variations</div>
                                        </div>
