...
<head>
    ...
    <style>
        ...
        /* Optional: Additional styles for better spacing and font */
        .sidebar-nav .metismenu li a span {
            flex-grow: 1;
        }

        .sidebar-nav .metismenu li a span:hover {
            color: #fff;
        }
    </style>
    <!-- Core css -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('produit-form') }}" id="addToTable" class="btn btn-primary mb-15"
                                        type="button">
                                        <i class="icon wb-plus" aria-hidden="true"></i> Ajouter un produit
                                    </a>
                                            ...
                                            <tbody>
                                                @foreach ($products as $product)
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>{{ $product->category ? $product->category->name : 'Aucune' }}
                                                        </td>
                                                        <td>{{ $product->marque ? $product->marque->name : 'Aucune' }}
                                                        </td>
                                                        <td class="actions">


                                                            <a href="/modifier-produit/{{ $product->id }}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="addrowExample_info" role="status"
                                                aria-live="polite">Afficher de 1 à {{ $products->count() }} sur
                                                {{ $totalEntries }} produits</div>
                                        </div>
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers"
    ...
    <script>
        function confirmDelete(id) {
            Swal.fire({
                ...
                text: 'les variations de ce produits vont être supprimé aussi',
                icon: 'warning',
