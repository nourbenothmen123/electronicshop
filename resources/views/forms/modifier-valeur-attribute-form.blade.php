            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Modifier la valeur d'attribut</h1>
                        </div>
                        @auth
            ...
            <div class="section-body">
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <form action="{{ route('modifier-ValeurAttribute-traitement') }}" method="POST">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        value="{{ $valeurAttribute->id }}">
                                        <input type="text" name="id_variation" style="display:none;"
                                            value="{{ $variation->id }}">
                                        <div class="form-group">
                                            <label class="form-label">Nom variation</label>
                                            <input type="text" class="form-control" name="nomvariation"
                                                value="{{ $variation ? $variation->name : '' }}" disabled>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="id_attribute"
                                                value="{{ $valeurAttribute->attribut_id}}">
                                            <label class="form-label">Nom attribute</label>
                                            <input type="text" class="form-control" name="nomAttribute"
                                                value="{{ $valeurAttribute->attribute->name}}" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Valeur</label>
                                            <input type="text" class="form-control" name="valeur"
                                                placeholder='entrer la valeur correspond à votre attribut'
                                                value="{{ $valeurAttribute->valeur }}">
                                        </div>
                                        @error('valeur')
