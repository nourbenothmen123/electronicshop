            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Ajouter un attribut</h1>
                        </div>
                        @auth
                ...
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('attributes.create') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group multiselect_div">
                                            <label><strong>Type d'attribute</strong></label>
                                            <select id="single-selection" name="type_attribute"
                                                class="multiselect multiselect-custom">
                                                <option value="Chaine de caractére">Chaine de caractére</option>
                                                <option value="Entier">Entier</option>
                                                <option value="Décimale">Décimale</option>
                                            </select>
                                        </div>
                                        
                                        <div class="form-group multiselect_div">
                                            <label><strong>Associer categorie(s)</strong></label>
