            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Ajouter une nouvelle promotion</h1>
                        </div>
                        @auth
                                            ...
                                            <div class="custom-controls-stacked">
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="type_promo[]" value="Catégorie" id="categoryCheck">
                                                    <span class="custom-control-label">Catégorie</span>
                                                </label>
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="type_promo[]" value="Produit" id="productCheck">
                                                    <span class="custom-control-label">Produit</span>
                                                </label>
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="type_promo[]" value="Variation" id="variationCheck">
