            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Ajouter une valeur d'attribut</h1>
                        </div>
                        @auth
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">Selectionner la variation</label>

                                            <select class="custom-select form-control" name="id_variation">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">Selectionner le nom d'attribut</label>

                                            <select class="custom-select form-control" name="id_attribut">
                                        ...
                                        @enderror
                                        <button type="submit" class="btn text-white bg-green">Ajouter</button>
                                    </div>
                            </form>
                        </div>
                    </div>
