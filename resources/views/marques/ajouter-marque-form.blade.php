            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Ajouter une nouvelle marque</h1>
                        </div>
                        @auth
            ...
            <div class="section-body">
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <form action="{{ route('marques.create') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group d-flex justify-content-center">
                                            ...
                                            <input type="text" class="form-control" name="nom_marque"
                                                placeholder='entrer le nom de votre marque'>
                                            </div>
                                        </div>
                                        @error('nom_marque')
