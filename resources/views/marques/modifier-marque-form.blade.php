            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Modifier une marque</h1>
                        </div>
                        @auth
            ...
            <div class="section-body">
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <form action="{{ route('modifier_marque_traitement') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-left" style="margin-left:192px">
                                            <strong><label class="form-label">Nom marque
                                                </label></strong>
                                        </div>
                                        ...
                                        <div class="form-group d-flex justify-content-left" style="margin-left:415px">
                                            <strong><label style="font-size:16px">Image marque
                                                </label></strong>
                                        </div>
                                        <div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <input type="file" class="dropify-fr"
                                                                name="image_marque" data-default-file="{{ asset('images/' . $marque->image) }}"
                                                                >
                                                        </div>
                                                    </div>
                                                </div>
