...
<body class="font-opensans">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('categorie-form') }}" id="addToTable"
                                        class="btn btn-primary mb-15" type="button">
                                        <i class="icon wb-plus" aria-hidden="true"></i> Ajouter une categorie
                                    </a>
                                    <form action="{{ url('/import-categories') }}" method="POST" id="importForm">
                                        @csrf
                                        <button type="submit" class="btn btn-danger mb-15" style="margin-left:900px">
                                            <i class="fa fa-arrow-circle-o-down mr-2"></i> Import categories
                                        </button>
                                    </form>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <form action="{{ route('index2') }}" method="GET" class="form-inline">
                                            ...
                                            <tbody>
                                                @foreach ($categories as $categorie)
                                                    <tr class="gradeA">
                                                        <td>{{ $categorie->id }}</td>
                                                        <td>
                                                            <img src="{{ asset('images/' . $categorie->category_image) }}"
                                                                width="60" height="60" />
                                                        </td>

                                                        <td>{{ $categorie->name }}</td>
                                                        <td>{{ $categorie->description }}</td>
                                                        <td>{{ $categorie->parent ? $categorie->parent->name : 'Aucune' }}
                                                        </td>
                                                        <td class="actions">

                                                           
                                                                <a href="/modifier-categorie/{{ $categorie->id }}"
                                                            ...
                                                            @can("supprimer catégorie")
                                                                <button type="submit"
                                                                    ...
                                                                    onclick="confirmDelete({{ $categorie->id }}, {{ $categorie->parent_id ?? 'null' }})">
                                    ...
                                    {{-- <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="addrowExample_info" role="status"
                                                aria-live="polite">Showing 1 to 10 of 35 entries</div>
                                        </div>
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers"
                                                id="addrowExample_paginate" style="margin-left:360px">
                                                <ul class="pagination">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="addrowExample_info" role="status"
                                                aria-live="polite">Afficher de 1 à {{ $categories->count() }} sur
                                                {{ $totalEntries }} catégories</div>
                                        </div>
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers"
    ...
    <script>
        function confirmDelete(id, idCatParent) {
            let textMessage = '';

            if (idCatParent === null) {
                textMessage =
                    "C'est une catégorie parente. Si vous la supprimez, leurs sous-catégories seront supprimées aussi.";
            } else {
                textMessage = "C'est une sous-catégorie.";
            }
            Swal.fire({
                title: 'Voulez-vous supprimer cette catégorie?',
                text: textMessage,
