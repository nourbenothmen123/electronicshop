...
<body class="font-opensans">
            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Liste des variations</h1>
                        </div>
                        @auth
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('variation-form') }}" id="addToTable"
                                        class="btn btn-primary mb-15" type="button">
                                        <i class="icon wb-plus" aria-hidden="true"></i> Ajouter une variation
                                    </a>

                                    <a href="{{ route('Valeur-Attribute') }}" id="addToTable"
                                        class="btn btn-primary mb-15" type="button">
                                        <i class="icon wb-plus" aria-hidden="true"></i> Liste des valeurs
                                        variation-attribut
                                    </a>
                                    <div class="row">
                                        ...
                                        <form action="{{ route('index4') }}" method="GET" class="col-sm-12 col-md-6">
                                            ...
                                            <tbody>
                                                @foreach ($variations as $variation)
                                                    <tr class="gradeA">
                                                        <td>{{ $variation->id }}</td>
                                                        <td>
                                                            <img src="images/{{ $variation->variation_image }}"
                                                                width="60" height="60" />
                                                        </td>
                                                        <td>{{ $variation->name }}</td>
                                                        <td>{{ $variation->product->name }}</td>
                                                        <td>{{ $variation->prix }} TND</td>
                                                        <td>{{ $variation->quantity_stock }}</td>

                                                        <td class="actions">

                                                            <a href="/modifier-variation/{{ $variation->id }}"
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('variations.destroy', $variation->id) }}" id="delete-form-{{ $variation->id }}">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                        </td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="addrowExample_info" role="status"
                                                aria-live="polite">Afficher de 1 à {{ $variations->count() }} sur
                                                {{ $totalEntries }} variations</div>
                                        </div>
    ...
    <script src="{{ asset('assets/js/page/index4.js') }}"></script>
    ...
    <script>
        function confirmDelete(id) {
            Swal.fire({
                title: 'Voulez-vous supprimer cette variation?',
                text: '',
                icon: 'warning',
