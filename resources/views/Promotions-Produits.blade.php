            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Liste des promotions sur des produits</h1>
                        </div>
                        @auth
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div
                                            ...
                                            <form action="{{ route('promotions_produits') }}" method="GET"
                                                ...
                                                <div id="addrowExample_filter" class="dataTables_filter mr-2">
                                                    <label><strong>Nom produit:<input type="search"
                                                                class="form-control" aria-controls="addrowExample"
                                                                name="chercherProduit"
                                                                value="{{ $chercherProduit }}"></strong></label>
                                                </div>
                                                ...
                                                @foreach ($promotions as $promo)
                                                    @foreach ($promo->products as $product)
                                                        <tr class="gradeA">
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge badge-info custom-badge">{{ $product->name }}</span>
                                                            </td>
                                                            <td>
                                                                <span
