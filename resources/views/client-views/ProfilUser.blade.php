...
<!-- Mirrored from portotheme.com/html/wolmart/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:40:45 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="container">
                    <div class="tab tab-vertical row gutter-lg">
                        <ul class="nav nav-tabs mb-6" role="tablist">
                            <li class="nav-item">
                                <a href="#account-dashboard" class="nav-link active">Tableau de board</a>
                            </li>
                            <li class="nav-item">
                                <a href="#account-orders" class="nav-link">Commandes</a>
                            </li>
                            <li class="nav-item">
                                <a href="#account-downloads" class="nav-link">Téléchargement</a>
                            </li>
                            <li class="nav-item">
                                <a href="#account-addresses" class="nav-link">Adresses</a>
                            </li>
                            <li class="nav-item">
                                <a id="account-details-link" href="#account-details" class="nav-link">Détails du
                                    compte</a>
                            </li>
                            <li class="link-item">
                                <a href="wishlist.html">Liste d'envies</a>
                            </li>
                            <li class="link-item">
                                <a href="{{ route('logout_client') }}">Se déconnecter</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content mb-6">
                            <div class="tab-pane active in" id="account-dashboard">
                                ...
                                <p class="mb-4">
                                    À partir du tableau de bord de votre compte, vous pouvez consulter vos, <a
                                        href="#account-orders" class="text-primary link-to-tab"> commandes
                                        récentes</a>,
                                    gérer vos<a href="#account-addresses" class="text-primary link-to-tab"> adresses
                                        de livraison et de facturation
                                    </a>, et
                                    <a href="#account-details" class="text-primary link-to-tab">modifier votre mot de
                                        passe et les détails de votre compte
                                    </a>
                                </p>
                                        ...
                                        <a href="#account-orders" class="link-to-tab">
                                            <div class="icon-box text-center">
                                                ...
                                                <div class="icon-box-content">
                                                    <p class="text-uppercase mb-0">Commandes</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                        <a href="#account-downloads" class="link-to-tab">
                                            <div class="icon-box text-center">
                                                ...
                                                <div class="icon-box-content">
                                                    <p class="text-uppercase mb-0">Téléchargement</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                        <a href="#account-details" class="link-to-tab">
                                            <div class="icon-box text-center">
                                                ...
                                                <div class="icon-box-content">
                                                    <p class="text-uppercase mb-0">Détails du compte</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                        <a href="wishlist.html" class="link-to-tab">
                                            <div class="icon-box text-center">
                                                ...
                                                <div class="icon-box-content">
                                                    <p class="text-uppercase mb-0">Liste d'envies</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="tab-pane mb-4" id="account-orders">
                                <div class="icon-box icon-box-side icon-box-light">
                                    ...
                                    <div class="icon-box-content">
                                        <h4 class="icon-box-title text-capitalize ls-normal mb-0">Commandes</h4>
                                    </div>
                                </div>
                                ...
                                <a href="shop-banner-sidebar.html"
                                    class="btn btn-dark btn-rounded btn-icon-right">aller magasiner
                            ...
                            <div class="tab-pane" id="account-details">
                                <form class="form account-details-form" action="{{ route('modifier_info_client') }}"
                                    method="POST">
                                    @csrf
                                    <div class="icon-box icon-box-side icon-box-light">
                                ...
                                <form class="form account-details-form"
                                    action="{{ route('changer_motDePasse_Client') }}" method="POST">
                                    ...
                                    @if ($errors->has('motdepasse_actuel'))
                                        <div class="alert alert-icon alert-error alert-bg alert-inline ">
                                            ...
                                            </h4>{{ $errors->first('motdepasse_actuel') }}
                                        </div>
                                    @endif
                                    <div class="form-group mb-6">
                                    ...
                                    <button type="submit" class="btn btn-dark btn-rounded btn-sm mb-4">Changer mot de
                                        passe
                                    </button>
                                </form>
                            </div>
...
<!-- Mirrored from portotheme.com/html/wolmart/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:40:48 GMT -->
