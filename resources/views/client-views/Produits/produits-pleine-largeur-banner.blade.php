...
<!-- Mirrored from portotheme.com/html/wolmart/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:42:28 GMT -->
<!-- Added by HTTrack -->
            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        <li><a href="{{ route('shop-fullwidth-banner') }}">Boutique</a></li>
                        <li>Liste</li>
                    </ul>
                </div>
            </nav>
                    ...
                    <div class="shop-content">
                        ...
                        <aside class="sidebar shop-sidebar left-sidebar sticky-sidebar-wrapper">
                            ...
                            <div class="sidebar-content scrollable">
                                ...
                                {{-- <div class="widget widget-collapsible">
                                    <h3 class="widget-title"><span>Tous les catégories</span></h3>
                                ...
                                <div class="widget widget-collapsible">
                                    ...
                                    <ul class="widget-body filter-items item-check mt-1">
                                        @foreach ($produitsCategorieSelectionné as $prodCat)
                                            @if (isset($prodCat->marque))
                                                <li><a href="#">{{ $prodCat->marque->name }}</a></li>
                                            @endif
                                        @endforeach
                        ...
                        <div class="main-content">
                            <nav class="toolbox sticky-toolbox sticky-content fix-top">
                                ...
                                <div class="toolbox-right">
                                    ...
                                    <div class="toolbox-item toolbox-layout">
                                        ...
                                        <a href="{{ route('shop-list') }}" class="icon-mode-list btn-layout">
                            ...
                            <div class="product-wrapper row cols-xl-2 cols-sm-1 cols-xs-2 cols-1">
                                @foreach ($produitsCategorieSelectionné as $prodCatSelectionné)
                                    {{-- Vérifier si le produit a des variations --}}

                                    <div class="product product-list product-select">
                                        <figure class="product-media">
                                            <a href="{{ route('product-variation', $prodCatSelectionné->id) }}">
                                                <img src="../../images/{{ $prodCatSelectionné->image }}"
                                        ...
                                        <div class="product-details">
                                            <div class="product-cat">
                                                <a
                                                    href="shop-banner-sidebar.html">{{ $prodCatSelectionné->category ? $prodCatSelectionné->category->name : 'Aucune' }}</a>
                                            </div>
                                            <h4 class="product-name">
                                                <a href="product-default.html">{{ $prodCatSelectionné->name }}</a>
                                            </h4>
                                            @if ($prodCatSelectionné->variations->isNotEmpty())
                                                <?php $minPrice = $prodCatSelectionné->variations->min('prix'); ?>
                                                <div class="product-price">{{ $minPrice }} DT</div>
                                            @endif
                                            <div class="product-desc">
                                                {{ $prodCatSelectionné->description }}
                                            </div>
                                            <div class="product-action">
                                                {{-- <a href="product-default.html" class="btn-product btn-cart"
                                                title="Add to Cart"><i class="w-icon-cart"></i></a> --}}
                        ...
                        <div class="product-meta">
                            <div class="product-categories">
                                ...
                                <span class="product-category"><a
                                        href="shop-banner-sidebar.html">Electronics</a></span>
                            </div>
...
<!-- Mirrored from portotheme.com/html/wolmart/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:42:30 GMT -->
