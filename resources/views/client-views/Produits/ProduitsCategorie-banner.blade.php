    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">{{ $nomCategorieSelectionné  }}</h1>
                </div>
            </div>
            <!-- Start of Breadcrumb -->
                ...
                <div class="container">
                    ...
                    {{-- <div class="shop-default-banner banner d-flex align-items-center mb-5 br-xs"
                        ...
                        <div class="banner-content">
                            <h4 class="banner-subtitle font-weight-bold">Catégorie : {{ $nomCategorieSelectionné  }}</h4>
                                                ...
                                                @foreach ($marques as $marque)
                                                    <li class="brand-item">
                                                        <input type="checkbox" class="brand-checkbox" name="brands[]"
                                                            value="{{ $marque->id }}" @if(in_array($marque->id, request('brands', []))) checked @endif>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="{{ route('product-variation', $prodCatSelectionné->id) }}">
                                                <img src="../../images/{{ $prodCatSelectionné->image }}" alt="Product" width="150"
                                                    height="200" />
                                            </a>
                                        ...
                                        <div class="product-details">
                                            <div class="product-cat">
                                                <a href="shop-banner-sidebar.html">{{ $prodCatSelectionné->category ? $prodCatSelectionné->category->name : 'Aucune' }}</a>
                                            </div>
