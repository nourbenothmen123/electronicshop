       ...
       @include('client-views.partials.header')
        ...
        <main class="main login-page">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">Créer un nouveau compte</h1>
                </div>
            </div>
            <!-- End of Page Header -->
                    ...
                    <div class="login-popup">
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            <ul class="nav nav-tabs text-uppercase" role="tablist">
                                <li class="nav-item">
                                    <a href="#sign-in" class="nav-link active">Inscription</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane active" id="sign-in">
                                    <form action="{{ route('register_client') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nom_utilisateur" id="username"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="adresse_email" id="username"
                                                required>
                                        </div>
                                        @error('adresse_email')
                                            <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="form-checkbox d-flex align-items-center justify-content-between">
                                            ...
                                            <label for="remember">Se souviens de moi</label>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="{{ route('AccueilPage') }}" class="logo-footer">
                                    <img src="{{ asset('client/assets/images/logo_electro_shop.png') }}"
                                        alt="logo-footer" width="210" height="100" />
                                </a>
                                <div class="widget-body">
                                    ...
                                    <div class="social-icons social-icons-colored">
                                        <a href="https://www.facebook.com/ElectronicShopSfax/"
