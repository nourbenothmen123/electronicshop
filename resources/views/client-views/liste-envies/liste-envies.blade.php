...
<!-- Mirrored from portotheme.com/html/wolmart/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:40:48 GMT -->
...
<head>
    ...
    <link rel="preload" href="{{ asset('client/assets/vendor/fontawesome-free/webfonts/fa-regular-400.woff2') }}" as="font" type="font/woff2"
        crossorigin="anonymous">
    <link rel="preload" href="{{ asset('client/assets/vendor/fontawesome-free/webfonts/fa-solid-900.woff2') }}" as="font" type="font/woff2"
        crossorigin="anonymous">
    <link rel="preload" href="{{ asset('client/assets/vendor/fontawesome-free/webfonts/fa-brands-400.woff2') }}" as="font" type="font/woff2"
            crossorigin="anonymous">
    <link rel="preload" href="{{ asset('client/assets/fonts/wolmart87d5.woff?png09e') }}" as="font" type="font/woff" crossorigin="anonymous">
    ...
    <div class="page-wrapper">
        ...
        <main class="main wishlist-page">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">Liste d'envies</h1>
                </div>
            </div>
            <!-- End of Page Header -->
...
<!-- Mirrored from portotheme.com/html/wolmart/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:40:51 GMT -->
</html>