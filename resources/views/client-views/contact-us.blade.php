...
<!-- Mirrored from portotheme.com/html/wolmart/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:40:42 GMT -->
<!-- Added by HTTrack -->
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">Contactez-nous</h1>
                </div>
            </div>
            <!-- End of Page Header -->
            ...
            <div class="page-content contact-us">
                <div class="container">
                    <section class="content-title-section mb-10">
                        <h3 class="title title-center mb-3">Coordonnées
                        </h3>
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-md-3 cols-sm-2 cols-1">
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        <h4 class="icon-box-title">Adresse E-mail</h4>
                                        <p><a href="https://portotheme.com/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="2548444c4965405d44485549400b464a48">najla@es-online.tn</a>
                                        </p>
                                        <p><a href="https://portotheme.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="2548444c4965405d44485549400b464a48">commercial@es-online.tn</a>
                                    </p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        <h4 class="icon-box-title">Numéro de téléphone</h4>
                                        <p>+216-99-850-000</p>
                                        <p>+216-93-588-000</p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        ...
                                        <p>Boulevard Farhat Hached, 3000 Sfax, Tunisia</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="contact-section">
                        <div class="row gutter-lg pb-3">
                            <div class="col-lg-6 mb-8">
                                <h4 class="title mb-3">Les gens demandent généralement ça</h4>
                                <div class="accordion accordion-bg accordion-gutter-md accordion-border">
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="#collapse1" class="collapse">Comment je peux annuler ma commande</a>
                                        </div>
                                        <div id="collapse1" class="card-body expanded">
                                            <p class="mb-0">
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                                temp orincid
                                                idunt ut labore et dolore magna aliqua. Venenatis tellus in metus vulp
                                                utate eu sceler
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="#collapse2" class="expand">Pourquoi mon inscription est-elle retardée ?</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="#collapse3" class="expand">De quoi ai-je besoin pour acheter des produits ?</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="#collapse4" class="expand">Comment je peux suivre ma commande</a>
                                        </div>
                            ...
                            <div class="col-lg-6 mb-8">
                                <h4 class="title mb-3">Envoyez-nous un message</h4>
                                <form class="form contact-us-form" action="#" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="email_1">Votre email</label>
                                    ...
                                    <button type="submit" class="btn btn-dark btn-rounded">Envoyer</button>
                                </form>
                            </div>
                        </div>
                    </section>
...
<!-- Mirrored from portotheme.com/html/wolmart/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 11:40:45 GMT -->
