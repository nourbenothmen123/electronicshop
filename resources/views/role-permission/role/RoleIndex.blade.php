                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('roles.create') }}" id="addToTable" class="btn btn-primary mb-15"
                                        type="button">
                                        <i class="icon wb-plus" aria-hidden="true"></i>Ajouter un rôle
                                    </a>
                                    <a href="{{ route('liste-rôle-permission') }}" class="btn btn-primary mb-15"
                                        type="button">
                                        <i class="icon wb-plus" aria-hidden="true"></i>Liste des rôles-permissions
                                    </a>
                                    <div class="row">
                                                ...
                                                @foreach ($roles as $role)
                                                    <tr class="gradeA">
                                                        ...
                                                        <td class="actions">
                                                            ...
                                                            <a href="{{ url('roles/' . $role->id . '/associer-permissions') }}"
                                                                class="btn btn-outline-success">Ajouter / Modifier
                                                                rôle permission</a>
                                                            <form method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="addrowExample_info" role="status"
                                                aria-live="polite">Afficher de 1 à {{ $roles->count() }} sur
                                                {{ $totalEntries }} rôles</div>
                                        </div>
