            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Ajouter un nouveau rôle</h1>
                        </div>
                        @auth
                            ...
                            <form action="{{ route('roles.store') }}" method="post">
                                ...
                                <div class="card">
                                    <div style="margin-top:5px;margin-left:1000px">
                                        <a href="{{ route('roles.index') }}" class="btn text-white bg-red"><strong>Annuler</strong></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-left" style="margin-left:192px">
                                            <strong><label class="form-label">Rôle
                                                </label></strong>
                                        </div>
                                        <div class="form-group d-flex justify-content-center">
                                            <div class="col-md-8">
                                            <input type="text" class="form-control" name="nomrôle"
                                                placeholder='entrer le nom de votre rôle'>
                                            </div>
                                        </div>
                                        @error('nomrôle')
