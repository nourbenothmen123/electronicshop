            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Ajouter une permission</h1>
                        </div>
                        @auth
                                ...
                                <div class="card">
                                    <div style="margin-top:5px;margin-left:1000px">
                                        <a href="{{ route('permissions.index') }}"
                                            class="btn text-white bg-red"><strong>Annuler</strong></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-left" style="margin-left:192px">
                                            <strong><label class="form-label">Permission
                                                </label></strong>
                                        </div>
                                        <div class="form-group d-flex justify-content-center">
                                            <div class="col-md-8">
                                            <input type="text" class="form-control" name="nompermission"
                                                placeholder='entrer le nom de votre permission'>
                                            </div>
                                        </div>
                                        @error('nompermission')
