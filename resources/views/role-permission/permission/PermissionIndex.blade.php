            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Liste des permissions</h1>
                        </div>
                        @auth
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('permissions.create') }}" id="addToTable"
                                        class="btn btn-primary mb-15" type="button">
                                        <i class="icon wb-plus" aria-hidden="true"></i>Ajouter une permission
                                    </a>
                                    <div class="row">
                                                ...
                                                @foreach ($permissions as $permission)
                                                    <tr class="gradeA">
                                                        ...
                                                        <td class="actions">
                                                            ...
                                                            @endcan
                                                            <form method="POST"
                                                                action="{{ route('permissions.destroy', $permission->id) }}" id="delete-form-{{ $permission->id }}">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                        </td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="addrowExample_info" role="status"
                                                aria-live="polite">Afficher de 1 à {{ $permissions->count() }} sur
                                                {{ $totalEntries }} permissions</div>
                                        </div>
