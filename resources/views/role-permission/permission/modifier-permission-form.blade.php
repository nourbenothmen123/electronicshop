            ...
            <div id="page_top" class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">Modifier une permission</h1>
                        </div>
                        @auth
                            ...
                            <form action="{{ route('permissions.update', $permission->id) }}" method="post">
                                ...
                                <div class="card">
                                    <div style="margin-top:5px;margin-left:1000px">
                                        <a href="{{ route('permissions.index') }}" class="btn text-white bg-red"><strong>Annuler</strong></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-left" style="margin-left:192px">
                                            <strong><label class="form-label">Nom Permission
                                                </label></strong>
                                        </div>
